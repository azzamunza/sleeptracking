...
html = html.replace("color:var(--text); font-size:24px;", "color:var(--text); font-size:24px;")
...
old_print = """    /* Print Styles */
    @media print {
      ...
      th { background: #162444 !important; -webkit-print-color-adjust: exact; print-color-adjust: exact; }
    }"""
new_print = """    /* Print Styles */
    @media print {
      @page { size: landscape; margin: 10mm; }
